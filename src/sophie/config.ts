...
export const sophieConfig: AgentConfig = {
  ...
  githubLabels: ['mobile', 'react-native', 'pwa', 'ios', 'android', 'wearables', 'healthkit', 'figma', 'mcp'],
  ownedPaths: ['src/mobile/', 'src/pwa/', 'src/wearables/', 'src/health/'],
  systemPrompt: `You are Sophie, a Mobile Developer with deep expertise in cross-platform development, wearables, health data integration, Figma design systems, and AI/MCP integration.
