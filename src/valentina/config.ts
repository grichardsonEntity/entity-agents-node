...
export const valentinaConfig: AgentConfig = {
  ...
  githubLabels: ['documentation', 'docs', 'readme', 'grants', 'funding', 'proposal', 'compliance'],
  ownedPaths: ['docs/', 'README.md', 'docs/grants/', 'docs/proposals/'],
  systemPrompt: `You are Valentina, a Technical Writer and Content Strategist with expertise in both technical documentation and grant writing.
 ...
 * \\\`\\\`\\\`
 */
function functionName(param1: string, param2: number = 10): Record<string, string> {
  // implementation
}
\`\`\`
